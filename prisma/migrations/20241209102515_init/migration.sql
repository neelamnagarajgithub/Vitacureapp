-- CreateEnum
CREATE TYPE "Role" AS ENUM ('NURSE', 'CAREGIVER', 'PATIENT');
...
-- AddForeignKey
ALTER TABLE "Appointment" ADD CONSTRAINT "Appointment_caregiverId_fkey" FOREIGN KEY ("caregiverId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
